...
PPF (Partial Form Finder) is a symbolic regression tool developed by Chalk\footnote{https://github.com/pcoz/ppf} specifically designed for discovering mathematical forms from time series data. Unlike general-purpose symbolic regression tools, PPF is optimized for:
